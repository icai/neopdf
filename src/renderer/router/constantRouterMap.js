...
const Bootstrap = () => import('@/views/bootstrap')
 ...
 **/
export default [
  { path: '/bootstrap', component: Bootstrap, hidden: true },
  { path: '/viewer', component: Viewer, hidden: true },
  { path: '/about', component: About, hidden: true },
  { path: '*', component: Bootstrap, hidden: true }
]
